...
function isApiProxyRoute(method, pathname) {
  ...
  if (method === "POST" && pathname === "/api/auth/phone/code") return true;
  if (method === "POST" && pathname === "/api/auth/phone/login") return true;
  if (method === "POST" && pathname === "/api/auth/phone/register") return true;
  ...
  if (method === "GET" && pathname === "/api/admin/audit-logs/archive/verifications") return true;
  ...
  if (method === "GET" && pathname === "/api/admin/merchant-qualifications") return true;
  if (method === "GET" && /^\/api\/admin\/merchant-qualifications\/[^/]+$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/admin\/merchant-qualifications\/[^/]+\/review$/.test(pathname)) return true;
  if (method === "GET" && pathname === "/api/admin/notifications") return true;
  if (method === "GET" && pathname === "/api/admin/notification-deliveries") return true;
  if (method === "POST" && pathname === "/api/admin/notification-deliveries/failure-alerts/emit") return true;
  if (method === "POST" && pathname === "/api/admin/notification-deliveries/retries/schedule") return true;
  if (method === "POST" && pathname === "/api/admin/notification-deliveries/quiet-window-retries/schedule") return true;
  if (method === "GET" && pathname === "/api/admin/notification-preferences") return true;
  if (method === "PUT" && pathname === "/api/admin/notification-preferences") return true;
  if (method === "POST" && pathname === "/api/admin/notification-preferences/batch") return true;
  if (method === "GET" && pathname === "/api/admin/notification-preferences/change-requests") return true;
  if (method === "POST" && pathname === "/api/admin/notification-preferences/change-requests") return true;
  if (method === "POST" && /^\/api\/admin\/notification-preferences\/change-requests\/[^/]+\/review$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/admin\/notification-preferences\/change-requests\/[^/]+\/apply$/.test(pathname)) return true;
  ...
  if (method === "GET" && /^\/api\/admin\/outbox\/events\/[^/]+$/.test(pathname)) return true;
  ...
  if (method === "POST" && pathname === "/api/notifications") return true;
  if (method === "POST" && pathname === "/api/notifications/provider-callback") return true;
  if (method === "POST" && /^\/api\/notifications\/[^/]+\/deliveries$/.test(pathname)) return true;
  if (method === "POST" && pathname === "/api/object-storage/upload-callback") return true;
  if (method === "POST" && pathname === "/api/object-storage/scan-result") return true;
  if (method === "GET" && pathname === "/api/merchant/me") return true;
  if (method === "GET" && pathname === "/api/merchant/notifications") return true;
  if (method === "POST" && /^\/api\/merchant\/notifications\/[^/]+\/read$/.test(pathname)) return true;
  if (method === "GET" && pathname === "/api/merchant/notification-preferences") return true;
  if (method === "PUT" && pathname === "/api/merchant/notification-preferences") return true;
  ...
  if (method === "GET" && pathname === "/api/user/profile") return true;
  if (method === "GET" && pathname === "/api/user/notification-preferences") return true;
  if (method === "PUT" && pathname === "/api/user/notification-preferences") return true;
  if (method === "GET" && pathname === "/api/user/coupons") return true;
  if (method === "POST" && pathname === "/api/user/coupons/claim") return true;
  if (method === "GET" && pathname === "/api/user/points") return true;
  if (method === "POST" && pathname === "/api/user/points/check-in") return true;
  if (method === "GET" && pathname === "/api/user/invite-summary") return true;
  if (method === "GET" && pathname === "/api/search") return true;
  if (method === "GET" && pathname === "/api/medicine/home") return true;
  if (method === "POST" && pathname === "/api/prescriptions/upload-ticket") return true;
  if (method === "POST" && pathname === "/api/prescriptions/upload-confirm") return true;
  if (method === "POST" && pathname === "/api/prescriptions") return true;
  if (method === "GET" && /^\/api\/prescriptions\/[^/]+$/.test(pathname)) return true;
  if (method === "POST" && pathname === "/api/medicine/orders") return true;
  if (method === "GET" && /^\/api\/medicine\/orders\/[^/]+$/.test(pathname)) return true;
  if (method === "POST" && pathname === "/api/errand/orders") return true;
  if (method === "GET" && /^\/api\/errand\/orders\/[^/]+$/.test(pathname)) return true;
  ...
  if (method === "GET" && pathname === "/api/reviews") return true;
  ...
  if (method === "GET" && pathname === "/api/feedback") return true;
  if (method === "POST" && pathname === "/api/feedback") return true;
  if (method === "GET" && pathname === "/api/service-tickets") return true;
  if (method === "POST" && pathname === "/api/service-tickets") return true;
  if (method === "GET" && /^\/api\/service-tickets\/[^/]+$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/service-tickets\/[^/]+\/events$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/service-tickets\/[^/]+\/close$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/service-tickets\/[^/]+\/follow-up$/.test(pathname)) return true;
  if (method === "GET" && pathname === "/api/admin/service-tickets") return true;
  if (method === "GET" && pathname === "/api/admin/service-ticket-quality-reviews") return true;
  if (method === "GET" && pathname === "/api/admin/service-ticket-performance") return true;
  if (method === "POST" && /^\/api\/admin\/service-tickets\/[^/]+\/assign$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/admin\/service-tickets\/[^/]+\/resolve$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/admin\/service-tickets\/[^/]+\/escalate$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/admin\/service-tickets\/[^/]+\/quality-review$/.test(pathname)) return true;
  if (method === "GET" && pathname === "/api/admin/prescriptions") return true;
  if (method === "POST" && /^\/api\/admin\/prescriptions\/[^/]+\/review$/.test(pathname)) return true;
  if (method === "GET" && pathname === "/api/circle/posts") return true;
  if (method === "POST" && pathname === "/api/circle/posts") return true;
  if (method === "GET" && pathname === "/api/meal-match/profile") return true;
  if (method === "PUT" && pathname === "/api/meal-match/profile") return true;
  if (method === "GET" && pathname === "/api/meal-match/candidates") return true;
  if (method === "POST" && pathname === "/api/meal-match/reports") return true;
  if (method === "POST" && pathname === "/api/meal-match/blocks") return true;
  if (method === "GET" && pathname === "/api/admin/meal-match/moderation") return true;
  if (method === "POST" && /^\/api\/admin\/meal-match\/moderation\/[^/]+\/review$/.test(pathname)) return true;
  if (method === "POST" && pathname === "/api/red-packets") return true;
  if (method === "GET" && /^\/api\/red-packets\/[^/]+$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/red-packets\/[^/]+\/claim$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/red-packets\/[^/]+\/refund$/.test(pathname)) return true;
  if (method === "POST" && pathname === "/api/admin/red-packets/expire") return true;
  if (method === "GET" && pathname === "/api/messages/threads") return true;
  if (method === "GET" && /^\/api\/messages\/[^/]+\/sync$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/messages\/[^/]+\/read$/.test(pathname)) return true;
  if (method === "GET" && /^\/api\/messages\/[^/]+$/.test(pathname)) return true;
  if (method === "POST" && /^\/api\/messages\/[^/]+$/.test(pathname)) return true;
  if (method === "GET" && pathname === "/api/wallet/transactions") return true;
  if (method === "GET" && pathname === "/api/wallet/overview") return true;
  if (method === "POST" && pathname === "/api/wallet/credit") return true;
  if (method === "POST" && pathname === "/api/wallet/withdraw") return true;
